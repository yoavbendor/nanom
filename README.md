...
table — [full methodology](docs/BENCH_RUST_NOM.md)).
...
**Equal-work head-to-head: nanom ~46 ns/pkt vs stable Rust nom ~52 ns/pkt — parity**, a hair in nanom's
favour, both zero-copy with no per-packet allocation. Scoped and reproducible
